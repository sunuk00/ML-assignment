...
결측치는 Linear Interpolation으로 채웠으며, 이는 시계열 데이터의 연속성을 유지하면서 자연스러운 값으로 보간하는 방법이다.
...
<img src="eda/outputs/step1_channel_properties.png" width="800" height="700">
...
<div style="display: flex; gap: 20px; justify-content: center;">
    <figure style="margin: 0; text-align: center;">
        <img src="eda/outputs/step2a_seasonal.png" width="500" height="400"/>
        <figcaption>Seasonality 분석</figcaption>
    </figure>
    <figure style="margin: 0; text-align: center;">
        <img src="eda/outputs/step2a_trend.png" width="500" height="400" />
        <figcaption>Trend 분석</figcaption>
    </figure>
        <figure style="margin: 0; text-align: center;">
        <img src="eda/outputs/step2a_residual.png" width="500" height="400" />
...
<img src="eda/outputs/step3a_correlation_matrix.png" width="700" height="800">
...
<img src="eda/outputs/step4a_anomaly_overview.png" width="800" height="700">