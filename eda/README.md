...
<img src="./outputs/step1_channel_properties.png" width="800" height="700">
...
<div style="display: flex; gap: 20px; justify-content: center;">
    <figure style="margin: 0; text-align: center;">
        <img src="./outputs/step2a_seasonal.png" width="500" height="400"/>
        <figcaption>Seasonality 분석</figcaption>
    </figure>
    <figure style="margin: 0; text-align: center;">
        <img src="./outputs/step2a_trend.png" width="500" height="400" />
        <figcaption>Trend 분석</figcaption>
    </figure>
        <figure style="margin: 0; text-align: center;">
        <img src="./outputs/step2a_residual.png" width="500" height="400" />
...
<img src="./outputs/step3a_correlation_matrix.png" width="700" height="800">
...
<img src="./outputs/step4a_anomaly_overview.png" width="800" height="700">