...
이산형 정보를 포함하지 않은 LOF-003+GMM-003 앙상블(AUPR 0.8149)보다 0.0065 낮지만, 10개 채널 전체를 활용한다는 점에서 LOF-Disc를 최종으로 채택.
...
- PR AUPR: LOF-Disc 0.712, GMM-003 0.731, **Ensemble 0.808** (Random=0.135)
