...
if __name__ == "__main__":
    ...
    print("=== 003 GMM — Rolling(W=200) + Skew/Kurt ===\n")
    ...
    # 6. Rolling 통계 (PCA 성분 기준, W=200, skew/kurt 포함)
    ...
    plot_full(val_scores, val_labels, test_scores, test_labels,
              tag="003_gmm_rolling_w200_skew_kurt", save_path=str(OUTPUT_DIR / "003_val_score_trace.png"))
    plot_zooms(val_scores, val_labels, test_scores, test_labels,
               tag="003_gmm_rolling_w200_skew_kurt", save_path=str(OUTPUT_DIR / "003_val_score_zoom.png"))
    plot_score_hist(val_scores, val_labels, test_scores, test_labels,
                    tag="003_gmm_rolling_w200_skew_kurt", save_path=str(OUTPUT_DIR / "003_score_hist.png"))
