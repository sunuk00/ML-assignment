...
if __name__ == "__main__":
    ...
    print("=== 014 IF — Rolling cont stats + Disc Ratio (W={}) ===\n".format(WINDOW_SIZE))
    ...
    plot_full(val_scores, val_labels, test_scores, test_labels,
              tag="014_ratio_rolling_w100", save_path=str(OUTPUT_DIR / "014_val_score_trace.png"))
    plot_zooms(val_scores, val_labels, test_scores, test_labels,
               tag="014_ratio_rolling_w100", save_path=str(OUTPUT_DIR / "014_val_score_zoom.png"))
    plot_score_hist(val_scores, val_labels, test_scores, test_labels,
                    tag="014_ratio_rolling_w100", save_path=str(OUTPUT_DIR / "014_score_hist.png"))
