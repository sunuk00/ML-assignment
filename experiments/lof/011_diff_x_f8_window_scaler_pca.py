...
if __name__ == "__main__":
    ...
    print("=== 011 LOF — x_f8 Diff + Window Stats(W=50) + StandardScaler + PCA ===\n")
    ...
    print(f"  feature dim: {train_X.shape[1]}  (cont {len(cont_cols)}×{len(STATS)} → scaler → PCA, W={WINDOW_SIZE})")
    ...
    plot_full(val_scores, val_labels, test_scores, test_labels,
              tag="011_lof_diff_x_f8_window_scaler_pca_w50",
