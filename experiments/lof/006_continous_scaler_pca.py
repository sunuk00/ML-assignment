...
if __name__ == "__main__":
    ...
    print("=== 006 LOF — Raw(Cont) + StandardScaler + PCA ===\n")
    ...
    # 6. 피처: raw 연속형 + StandardScaler + PCA
    train_X = train_pca.to_numpy()
    val_X   = val_pca.to_numpy()
    test_X  = test_pca.to_numpy()
    print(f"  feature dim: {train_X.shape[1]}  (raw_cont -> scaler -> pca)")
    ...
    plot_full(val_scores, val_labels, test_scores, test_labels,
              tag="006_lof_raw_cont_scaler_pca", save_path=str(OUTPUT_DIR / "006_val_score_trace.png"))
    plot_zooms(val_scores, val_labels, test_scores, test_labels,
               tag="006_lof_raw_cont_scaler_pca", save_path=str(OUTPUT_DIR / "006_val_score_zoom.png"))
    plot_score_hist(val_scores, val_labels, test_scores, test_labels,
                    tag="006_lof_raw_cont_scaler_pca", save_path=str(OUTPUT_DIR / "006_score_hist.png"))